...
class PipelineRunner:
    ...
    def run(
        ...
        for step in steps:
            ...
            allowed_transient_health = (
                    regressed and after.health in step.allowed_health_regressions
            )
            if result.status is not expected_status or (
                    regressed and not allowed_transient_health
            ):
